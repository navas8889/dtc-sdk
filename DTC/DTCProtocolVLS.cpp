...
/*==========================================================================*/
	...
	{
		if (BaseSize < offsetof(s_AccountBalanceUpdate, OpenPositionsProfitLossBasedOnSettlementPrice) + sizeof(OpenPositionsProfitLossBasedOnSettlementPrice))
		{
			return 0.0;
		}
	...
	/*==========================================================================*/
	DTC::t_DateTimeWithMicrosecondsInt s_AccountBalanceUpdate::GetLastOrderActivityDateTime() const
	{
		if (BaseSize < offsetof(s_AccountBalanceUpdate, LastOrderActivityDateTime) + sizeof(LastOrderActivityDateTime))
		{
			return 0;
		}
	...
	{
		if (BaseSize < offsetof(s_HistoricalPriceDataRequest, UseZLibNGCompression) + sizeof(UseZLibNGCompression))
		{
			return 0;
		}
	...
	{
		if (BaseSize < offsetof(s_HistoricalMarketDepthDataRequest, UseZLibNGCompression) + sizeof(UseZLibNGCompression))
		{
			return 0;
		}
